...
| 2026-09-05 08:54 | auditoria-claude | 92 arquivos, modelo sonnet | `historico/auditorias/auditoria-claude-tripvisuals-2026-09-05T11-54-55-689Z.md` |
| 2026-09-05 08:54 | ui-padrao | Entidade: Produtos \| Campos: nome, preço, categoria, cor, tipo, gênero, banda, descrição, destaque, oculto \| Tem filtro/paginação: sim (busca texto + filtros de tipo/banda/gênero/categoria + 3 filtros rápidos no painel lateral; paginação de 24 itens/página) | — |
| 2026-09-05 08:54 | ui-padrao | Entidade: Pedidos \| Campos: produto, tamanho, cliente, WhatsApp, valor, CEP, notas, status \| Tem filtro/paginação: filtro sim (chips de status), paginação não (lista completa carregada de uma vez) | — |
| 2026-09-05 08:54 | ui-padrao | Entidade: Resultados do Catalogador IA \| Campos: imagem, arquivo original, banda identificada, arquivo de saída \| Tem filtro/paginação: não (sem busca, sem paginação — lista cresce livremente durante a sessão) | — |
| 2026-09-05 08:54 | ui-padrao | Entidade: Frete por região (UF) \| Campos: UF, valor, prazo em dias \| Tem filtro/paginação: não (lista pequena, só adicionar/remover, sem edição inline nem paginação) | — |
